...
{
	Wektor<float,float,float,float> wierzcholki[] = {
		 Wektor <float,float,float,float> (-0.4f, -0.4f, 0.0f, 1.0f),
		 Wektor <float,float,float,float> (1.0f,  0.0f, 0.0f, 1.0f),
		 Wektor<float,float,float,float>(0.4f, -0.4f, 0.4f, 1.0f),
		 Wektor<float,float,float,float>(0.0f,  1.0f, 0.0f, 1.0f),
		 Wektor<float,float,float,float>(-0.4f,  0.4f, 0.0f, 1.0f),
		 Wektor<float,float,float,float>(0.0f,  0.0f, 1.0f, 1.0f),
		 Wektor<float,float,float,float>(0.4f,  0.4f, 0.0f, 1.0f),
		 Wektor<float,float,float,float>(0.5f,  0.5f, 0.0f, 1.0f),
	};
...
int main(int argc, char** argv)
{
	...
	Wektor<float, float, float, float> w (float (3.34),float(5.23),float(6.35),float(7.34));
	Wektor<float, float, float, float> z (float(5.34), float(6.23), float(7.35), float(8.34));
	
	
		

	std::cout << w << std::endl;
	std::cout <<"dlugosc wektora: "<< w.dlugosc_wektora() << std::endl;
	std::cout << "iloczyn skalarny: " << w.iloczyn_skalarny(w) << std::endl;
	std::cout << "iloczyn wektorowy: " << w.iloczyn_skalarny(z) << std::endl;
